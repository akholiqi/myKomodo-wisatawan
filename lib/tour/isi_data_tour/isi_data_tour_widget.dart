                          ...
                          Padding(
                            ...
                            child: FFButtonWidget(
                              onPressed: () async {
                                ...
                                print('print : ${FFAppState().accessToken}');
                                print('tour id : ${getJsonField(widget.tourData, r'''$.id''')
                                          .toString()}');
                                print('tour price : ${getJsonField(
                                      widget.tourData, r'''$.price''')}');
                                print('tour isPrivate : ${getJsonField(
                                          widget.tourData, r'''$.is_private''')
                                      .toString()}');
                                print('tour startDate : ${valueOrDefault<String>(
                                    functions.formatDate(dateTimeFormat(
                                        'd/M/y', FFAppState().startDate)),
                                    'null')}');
                                print('tour totalGuests : ${_model.countControllerValue!.toString()}');
                                print('tour totalPrice : ${(_model.countControllerValue! *
                                          double.parse(getJsonField(
                                              widget.tourData, r'''$.price''')))
                                      .toInt()
                                      .toString()}');
                                
                                print(_model.tourBooking!.jsonBody);
                                await Navigator.push(
                                  context,
                                  MaterialPageRoute(
                                    builder: (context) =>
