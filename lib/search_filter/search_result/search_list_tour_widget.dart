import 'package:mykomodov2/flutter_flow/flutter_flow_widgets.dart';
import 'package:mykomodov2/main.dart';
import 'package:mykomodov2/search_filter/pilih_lokasi/pilih_lokasi_widget.dart';
import 'package:mykomodov2/search_filter/search_produk/search_produk_widget.dart';
              ...
              children: [
                ...
                Padding(
                  ...
                  child: FutureBuilder<ApiCallResponse>(
                    ...
                    // future: TourSearchGroup.searchTourListCall.call(
                    //   keyword: widget.searchData
                    // ),
                      ...
                      return Builder(
                        builder: (context) {
                          ...
                          final filteredTourList =
                              tourList.where((dynamic tourListItem) {
                            final isPrivate = tourListItem['is_private'] ?? 0;
                            // Logika pencarian berdasarkan teks pada judul tur (title)
                            if (widget.searchData != null &&
                                widget.searchData!.isNotEmpty) {
                              final title =
                                  tourListItem['title']?.toLowerCase() ?? '';
                              final searchQuery =
                                  widget.searchData!.toLowerCase();
                              return title.contains(searchQuery) &&
                                  ((_model.switchValue! && isPrivate == 1) ||
